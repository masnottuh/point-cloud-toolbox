...
neighbors_for_surface_fit = [5, 10, 15, 20, 25] #minimum of 4!
voxel_size = [2, 1, 0.5, 0] #set to zero if you don't need to downsample
    ...
    for cloud_type in ['sridge', 'sphere', 'torus', 'klein', 'dupin', 'monkey', 'bumpy_spheroid']:
        for voxel_size in voxel_size:
            for neighbors in neighbors_for_surface_fit:
                ...
                # print("Running neighbor study")
                # pcl.explicit_quadratic_neighbor_study(method = 'standard') # use 'goldmans' or 'standard'
                ...
                # pcl.calculate_curvatures_of_explicit_quadratic_surfaces_for_all_points(method = 'standard') # use 'goldmans' or 'standard'
