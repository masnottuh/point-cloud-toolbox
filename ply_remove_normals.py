...
# Usage example
input_ply_file = "Scans/UState_Pos134.082_Trial1_1.ply"  # Replace with the actual input PLY file name
output_ply_file = "Scans/NN_UState_Pos134.082_Trial1_1.ply"  # Replace with the desired output PLY file name
